...
@Component({
  selector: 'app-reservar-curso',
  templateUrl: './reservar-curso.component.html',
  styleUrls: ['./reservar-curso.component.css']
})
export class ReservarCursoComponent implements OnInit {
